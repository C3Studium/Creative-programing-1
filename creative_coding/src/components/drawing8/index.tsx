...
export default function Drawing8() {
    ...
    class Particle {
        ...
        constructor(params: { x: number, y: number, r: number, vx: number, vy: number, ax: number, ay: number, color: string, minDis: number, pushFactor: number, ix: number, iy: number, fx: number, fy: number }) {
            ...
            // min distance
            this.minDis = random.range(10, 200)
        ...
        update() {
            ...
            this.scale = math.mapRange(dd, 0, 200, 1, 10);
    ...
    const onMouseMove = (e: MouseEvent) => {
        ...
        console.log(cursorCoords.current.x, cursorCoords.current.y)
